...
Go to this site https://drive.google.com/drive/folders/11-miY1tK7kxk4J4_xXWRu0iel-0aiYJa and download the folder. 

The dummy data is all provided free by our friend [Jason Staats](https://www.linkedin.com/in/jstaats/)
...
"Create a spreadsheet summarising the transactions in this folder, and create a dashboard that shows the breakdown of spend categories"
...
We have [an example using a pre-defined build file](/resources/build-a-site/) you can try.

It uses a [CLAUDE.md](/resources/build-a-site/CLAUDE.MD) file with definitions on what to do, so you don't have to prompt from scratch. You can read the file to get an understand of how the project has been setup, and maybe you can even create your own!
