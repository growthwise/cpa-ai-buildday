...
We have an example using a pre-defined build file that you can try [here](build-a-site) 

This uses a [CLAUDE.MD](build-a-site/CLAUDE.MD) file with definitions on what to do, instead of requiring prompting. 
