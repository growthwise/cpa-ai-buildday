...
The instructions below are for Claude Cowork, however if you are using OpenAI Codex you can just specify the folder as your project, it will impoort CLAUDE.MD as AGENTS.MD and you can then type
